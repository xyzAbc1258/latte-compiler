...
instance Print (AbsLatte.Ext a) where
  prt i e = case e of
    ...
    AbsLatte.ClassExt _ type_ -> prPrec i 0 (concatD [doc (showString "extends"), prt 0 type_])
...
instance Print (AbsLatte.Stmt a) where
  prt i e = case e of
    ...
    AbsLatte.For _ type_ id expr stmt -> prPrec i 0 (concatD [doc (showString "for"), doc (showString "("), prt 0 type_, prt 0 id, doc (showString "in"), prt 0 expr, doc (showString ")"), prt 0 stmt])
...
instance Print (AbsLatte.Type a) where
  prt i e = case e of
    ...
    AbsLatte.Class _ id -> prPrec i 0 (concatD [prt 0 id])
    AbsLatte.Array _ type_ -> prPrec i 0 (concatD [prt 0 type_, doc (showString "["), doc (showString "]")])
...
instance Print (AbsLatte.Expr a) where
  prt i e = case e of
    ...
    AbsLatte.ENewObj _ type_ -> prPrec i 6 (concatD [doc (showString "new"), prt 0 type_])
    AbsLatte.EObjFldAcc _ expr id -> prPrec i 6 (concatD [prt 0 expr, doc (showString "."), prt 0 id])
    AbsLatte.EObjFuncApp _ expr id exprs -> prPrec i 6 (concatD [prt 0 expr, doc (showString "."), prt 0 id, doc (showString "("), prt 0 exprs, doc (showString ")")])
    AbsLatte.ENewArr _ type_ expr -> prPrec i 6 (concatD [doc (showString "new"), prt 0 type_, doc (showString "["), prt 0 expr, doc (showString "]")])
    AbsLatte.EArrAcc _ expr1 expr2 -> prPrec i 6 (concatD [prt 0 expr1, doc (showString "["), prt 0 expr2, doc (showString "]")])
