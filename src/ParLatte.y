...
TopDef : Type Ident '(' ListArg ')' Block { AbsLatte.FnDef () $1 $2 $4 $6 }
       | 'class' Ident Ext '{' ListClDecl '}' { AbsLatte.ClDef () $2 $3 $5 }
ListTopDef :: { [TopDef ()] }
...
ListArg : {- empty -} { [] }
        ...
        | Arg ',' ListArg { (:) $1 $3 }
ListClDecl :: { [ClDecl ()] }
ListClDecl : ClDecl { (:[]) $1 } | ClDecl ListClDecl { (:) $1 $2 }
ClDecl :: { (ClDecl ()) }
ClDecl : Type Ident ';' { AbsLatte.ClFld () $1 $2 }
       | Type Ident '(' ListArg ')' Block { AbsLatte.ClFunc () $1 $2 $4 $6 }
Ext :: { (Ext ()) }
Ext : {- empty -} { AbsLatte.NoExt () }
    | 'extends' Ident { AbsLatte.ClassExt () $2 }
FuncDec :: { (FuncDec ()) }
FuncDec : Type Ident '(' ListType ')' { AbsLatte.FuncDecl () $1 $2 $4 }
ListFuncDec :: { [FuncDec ()] }
ListFuncDec : {- empty -} { [] }
            | FuncDec { (:[]) $1 }
            | FuncDec ',' ListFuncDec { (:) $1 $3 }
Block :: { (Block ()) }
...
Stmt : ';' { AbsLatte.Empty () }
     ...
     | Expr6 '=' Expr ';' { AbsLatte.Ass () $1 $3 }
     | Expr6 '++' ';' { AbsLatte.Incr () $1 }
     | Expr6 '--' ';' { AbsLatte.Decr () $1 }
...
Type1 :: { Type () }
Type1 : 'int' { AbsLatte.Int () }
      | 'string' { AbsLatte.Str () }
      | 'boolean' { AbsLatte.Bool () }
      | 'void' { AbsLatte.Void () }
      | Ident { AbsLatte.Class () $1 }
Type :: { (Type ()) }
Type : Type '[]' { AbsLatte.Array () $1 } | Type1 { $1 }
ListType :: { [Type ()] }
ListType : {- empty -} { [] }
         | Type { (:[]) $1 }
         | Type ',' ListType { (:) $1 $3 }
...
Expr7 : Ident { AbsLatte.EVar () $1 }
      ...
      | Expr7 '.' Ident { AbsLatte.EFldAcc () $1 $3 }
      | Expr7 '[' Expr3 ']' { AbsLatte.EArrAcc () $1 $3 }
      | Expr7 '(' ListExpr ')' { AbsLatte.EApp () $1 $3 }
      | String { AbsLatte.EString () $1 }
      | '(' Type ')null' { AbsLatte.ENull () $2 }
      | '(' Expr ')' { $2 }
BranchV :: { (BranchV ()) }
BranchV : Expr7 Ident { AbsLatte.BranchVar () $1 $2 }
ListBranchV :: { [BranchV ()] }
ListBranchV : {- empty -} { [] }
            | BranchV { (:[]) $1 }
            | BranchV ',' ListBranchV { (:) $1 $3 }
Expr6 :: { Expr () }
Expr6 : 'new' Type1 { AbsLatte.ENewObj () $2 }
      | 'new' Type '[' Expr3 ']' { AbsLatte.ENewArr () $2 $4 }
      | Expr7 { $1 }
Expr5 :: { Expr () }
