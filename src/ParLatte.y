...
| 'class' Ident Ext '{' ListClDecl '}' {
  (Just (tokenLineCol $1), AbsLatte.ClDef (Just (tokenLineCol $1)) (snd $2)(snd $3)(snd $5)) 
}
...
: Type Ident ';' {
  (fst $1, AbsLatte.ClFld (fst $1)(snd $1)(snd $2)) 
}
| Type Ident '(' ListArg ')' Block {
  (fst $1, AbsLatte.ClFunc (fst $1)(snd $1)(snd $2)(snd $4)(snd $6)) 
}

Ext :: {
  (Maybe (Int, Int), Ext (Maybe (Int, Int)))
}
: {
  (Nothing, AbsLatte.NoExt Nothing)
}
| 'extends' Ident {
...
FuncDec :: {
  (Maybe (Int, Int), FuncDec (Maybe (Int, Int)))
}
: Type Ident '(' ListType ')' {
  (fst $1, AbsLatte.FuncDecl (fst $1)(snd $1)(snd $2)(snd $4)) 
}
...
| Expr7 '.' Ident {
  (fst $1, AbsLatte.EFldAcc (fst $1)(snd $1)(snd $3)) 
}
| Expr7 '[' Expr3 ']' {
  (fst $1, AbsLatte.EArrAcc (fst $1)(snd $1)(snd $3)) 
}
| Expr7 '(' ListExpr ')' {
...
BranchV :: {
  (Maybe (Int, Int), BranchV (Maybe (Int, Int)))
}
: Expr7 Ident {
  (fst $1, AbsLatte.BranchVar (fst $1)(snd $1)(snd $2)) 
}
